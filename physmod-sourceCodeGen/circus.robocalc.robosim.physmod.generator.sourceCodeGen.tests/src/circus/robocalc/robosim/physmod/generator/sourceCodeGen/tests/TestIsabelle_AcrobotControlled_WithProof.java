...
public class TestIsabelle_AcrobotControlled_WithProof {
    ...
    private Path testRoot() {
        ...
        Path fromTestdata = resolveTestdataPath("RobotExamples/AcrobotControlled/SKO_proof");
    ...
    private Path tempOutputRoot() {
        try {
            return Files.createTempDirectory("TestIsabelle_AcrobotControlled");
    ...
    @Test
    public void testIsabelleWithProofBlock_AcrobotControlled() throws Exception {
        Path inputPath = testRoot().resolve("input").resolve("acrobotControlled_WithProof.slnRef");
        ...
        try {
            ...
            assertTrue(theoryContent.contains("B_ctrl"),
                "Theory should contain B_ctrl variable for controllability analysis");

            assertTrue(theoryContent.contains("dataspace"),
                "Theory should contain dataspace block for ISAVodes format");

            // Persist the Isabelle theory output
            ...
            System.out.println("Generated Isabelle theory with B_ctrl written to: " + theoryFile);
