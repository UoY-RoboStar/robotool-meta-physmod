...
// derived from world state (e.g., gravity, object positions, distances)
// and platform state (e.g., joint encoders).
...
public:
    ...
    void computeSensorReadings(
        ...
        // NOTE: Platform sensors (joint encoders) are copied from platform_state here.
