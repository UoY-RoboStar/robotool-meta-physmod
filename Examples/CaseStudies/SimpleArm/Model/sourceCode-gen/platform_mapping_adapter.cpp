...
public:
    ...
    void updateFromSensors(const sensor_data_t& sensor_output) override {
        ...
        p_mapping.__synthetic0.BaseLink.ShoulderEncoder.AngleOut =
            sensor_output.__synthetic0.BaseLink.ShoulderEncoder.AngleOut;
        p_mapping.__synthetic0.BaseLink.ShoulderEncoder.VelocityOut =
            sensor_output.__synthetic0.BaseLink.ShoulderEncoder.VelocityOut;
        p_mapping.__synthetic0.Link1.ElbowEncoder.AngleOut =
            sensor_output.__synthetic0.Link1.ElbowEncoder.AngleOut;
        p_mapping.__synthetic0.Link1.ElbowEncoder.VelocityOut =
            sensor_output.__synthetic0.Link1.ElbowEncoder.VelocityOut;
    }
};
