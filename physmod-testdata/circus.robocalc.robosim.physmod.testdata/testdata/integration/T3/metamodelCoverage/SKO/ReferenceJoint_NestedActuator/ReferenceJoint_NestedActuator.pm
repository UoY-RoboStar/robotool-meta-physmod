// SKO Metamodel coverage test: Reference joint containing a nested reference actuator
// Purpose: Verify that eqnComp localises the reference joint and preserves the nested
// reference actuator inside it (not moved to link scope)
import physmod::SKO::joints::Revolute_x
import physmod::trivial::actuators::TrivialMotor

pmodel ReferenceJoint_NestedActuator {
    local link BaseLink {
        def {
            const number: nat = 0
        }
