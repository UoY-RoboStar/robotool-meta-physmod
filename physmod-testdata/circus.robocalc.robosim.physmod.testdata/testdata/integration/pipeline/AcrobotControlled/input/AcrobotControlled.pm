...
pmodel AcrobotControlled {
    local link BaseLink {
        ...
        // Shoulder joint: passive revolute about X-axis (unactuated)
        jref ShoulderJoint = Revolute_x {
        ...
        pose { x = 0.0 y = 0.0 z = -0.1 roll = 0.0 pitch = 0.0 yaw = 0.0 }
    }
    ...
    local link Link1 {
        ...
        // Elbow joint: actuated revolute about X-axis with ControlledMotor
        ...
        pose { x = 0.0 y = 0.0 z = -0.55 roll = 0.0 pitch = 0.0 yaw = 0.0 }
    }
    ...
    local link Link2 {
        ...
        pose { x = 0.0 y = 0.0 z = -1.05 roll = 0.0 pitch = 0.0 yaw = 0.0 }
    }
}
