...
public:
    ...
    void computeSensorReadings(
        ...
        out.Turtlebot3.Burger.BaseLink.TBLidar.angle_min = angle;
        out.Turtlebot3.Burger.BaseLink.TBLidar.closestDistance = distance;
        out.Turtlebot3.Burger.BaseLink.TBLidar.closestAngle = angle;
        out.Turtlebot3.Burger.BaseLink.TBLidar.scan.range_min = distance;
        out.Turtlebot3.Burger.BaseLink.TBLidar.scan.angle_min = angle;
        ...
        w_mapping.Turtlebot3.Burger.BaseLink.TBLidar.angle_min = angle;
        w_mapping.Turtlebot3.Burger.BaseLink.TBLidar.closestDistance = distance;
        w_mapping.Turtlebot3.Burger.BaseLink.TBLidar.closestAngle = angle;
        w_mapping.Turtlebot3.Burger.BaseLink.TBLidar.scan.range_min = distance;
        w_mapping.Turtlebot3.Burger.BaseLink.TBLidar.scan.angle_min = angle;
